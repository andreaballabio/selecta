    ...
    Tables: {
      labels: {
        Row: {
          ...
          target_artist_level: 'emerging' | 'mid' | 'established' | 'all' | null
      ...
      user_tracks: {
        Row: {
          ...
          file_format: 'wav' | 'mp3' | 'aiff' | 'flac' | null
          bpm: number | null
          key: string | null
          scale: string | null
      ...
      profiles: {
        Row: {
          ...
          career_level: 'beginner' | 'emerging' | 'mid' | 'established' | 'professional' | null
